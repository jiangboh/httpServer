...
namespace httpServer
{
    ...
    {
        static public string FormTitle = "博威通小网管服务器";
        ...
        static void Main()
        {
            ...
            string str = currentproc.ProcessName.Replace(".vshost", string.Empty);
            Process[] processcollection = Process.GetProcessesByName(str);
            //  该程序已经运行，
